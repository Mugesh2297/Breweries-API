...
const displayData = (data) => {
  ...
  data.forEach((ele) => {
    ...
    <h4 class="card-text h4">Website <i class= "fa fa-globe"></i> <a href="https://www.openbrewerydb.org/">https://www.openbrewerydb.org/</a></h4>
    </div>`
    ...
    <h4 class="card-text h4" id="website"> Website <i class="fa fa-globe"></i><a href=" ${ele.website_url}" target=_blank> ${ele.website_url} </a>  </h4>
...
function displayCountries(data) {
  if (`${data.website_url}` == "null" || `${data.street}` == "null" || `${data.phone}`=="null") {
    ...
    <h4 class="card-text h4">Phone <i class="fa fa-phone"></i> : 5034278619</h4>
    <h4 class="card-text h4" id="website">Website <i class="fa fa-globe"></i> <a href="https://www.openbrewerydb.org/" target=_blank>https://www.openbrewerydb.org/</a> </h4>
    ...
    <h4 class="card-text h4" id="website"> Website <i class="fa fa-globe"></i>  <a href="${data.website_url}" target=_blank> ${data.website_url} </a>  </h4>
